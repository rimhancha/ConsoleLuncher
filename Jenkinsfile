...
checkout scm:[$class:'GitSCM',
              userRemoteConfigs:[[credentialsId:'IDKEYRIM',
...
bat'mkdir lib' 
bat'cd lib' 
  bat'curl.exe -o "lib/junit-platform-console-standalone-1.8.1.jar""https://https://repo1.maven.org/maven2/org/junit/platform/junit-platform-console-standalone/1.8.1//junit-platform-console-standalone-1.8.1.jar"' 
